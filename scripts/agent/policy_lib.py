...
Canonical shared policy source. Both .codex/hooks/ and .claude/hooks/ import
from this location. Mirror meaningful policy changes here rather than in adapter
copies.
...
DENY_PATTERNS = [
    ...
    (r"\bgit\s+push\b.*\b(main|master|prod|production|release/[^ ]+)\b", "Direct push to protected branch is blocked."),
